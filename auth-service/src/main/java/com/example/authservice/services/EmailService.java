...
/**
 * Service for sending emails, such as welcome messages and verification codes, using Thymeleaf templates.
 */
@Slf4j
@Service
...
public class EmailService {
     ...
     *
     * @param user the {@link UserEntity} to send the email to
     * @throws IllegalArgumentException if the user, email, or password reset token is null or invalid
     * @throws EmailSendingException if an error occurs while sending the email
     */
    @Async
